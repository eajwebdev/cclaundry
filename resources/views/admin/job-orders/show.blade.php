...
<div x-data="{ receiptOpen: false }" class="space-y-4">
    ...
    <div x-cloak x-show="receiptOpen" :class="{ 'is-active-receipt': receiptOpen }" class="receipt-modal fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
