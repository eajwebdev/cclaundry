{{--
    The run list on its own, so the same markup serves the first paint and
    every refresh. The page polls for a new copy of this and swaps it in,
    which keeps the server the single author of how a run looks.
--}}
